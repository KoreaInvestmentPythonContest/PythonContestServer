...
class News(models.Model):
    ...
    text = models.CharField(db_column='TEXT', max_length=2000, db_collation='utf8_general_ci', blank=True, null=True)  # Field name made lowercase.
    extr_stck_nm = models.CharField(db_column='EXTR_STCK_NM', max_length=20, db_collation='utf8_general_ci', blank=True, null=True)  # Field name made lowercase.
    img_url_list = models.CharField(db_column='IMG_URL_LIST', max_length=200, blank=True, null=True)  # Field name made lowercase.
